...
#aods = [0.075]
alb_scalings = [1.0, 1.3, 1.5, 2, 2.5, 3, 3.5, 4]
#alb_scaling = [1.0]
flipSigns = [1.0]
#flipSigns = [1.0,   -1.0]
p_aero = 800.0
...
@save "simulated_rads_VariableAlbedoTropics.jld2" R_conv_carbonI_dict 
...
function plotResults()
    ...
    n2o = CairoMakie.heatmap!(ax2,aods, alb_scalings*0.0425,ratios_n2o[:,:,1,1], colormap = :viridis, colorbar = false, colorrange=ranger)
...
plotResults()
f = plotResults()
save("plots/ProxyPaper/ProxyTropical2D.pdf", f)