...
vmr_h2o = [  5e-6,   5e-6,   5e-6,   5e-6,   5e-61,   5e-6,   
...
p = Legendre([2.0,0.000001,0.00000001, 0.000000001]);
...
e_n2o  = CarbonI.createErrorVector(profile.p/1e2,utls,bl, rel_error, gasProfiles[2])
...
e_co2[1:n_layers-1] = 0.0002*gasProfiles[1][1:n_layers-1]
e_n2o[1:n_layers-1] = 0.0002*gasProfiles[2][1:n_layers-1]
...
@save "mw1_fits_all_noH2O_sub.jld2" n2o_mw1 co2_mw1 co2_13_mw1 h2o_mw1