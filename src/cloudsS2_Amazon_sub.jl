...
x = [30,60,90,120,  150, 200, 300, 400, 600, 800, 1000, 1250, 1500, 1750, 2000,3000, 5000, 7500]#, 3000, 5000, 7500, 10000];
datasets = []
for res in (30,60,90,120, 150, 200, 300, 400, 600, 800, 1000, 1250, 1500, 1750, 2000,3000, 5000, 7500)#, 3000, 5000, 7500, 10000)
    files = Glob.glob("AmazonBox2018-01-01_2022-01-01_-7[45].0_-[12].0_"* string(res)*".0.csv","/home/cfranken/shared/GE_BOX2/")
