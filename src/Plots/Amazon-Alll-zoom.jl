...
CMAP_CO  = cgrad(:Oranges, 21; categorical=true)
...
function save_frame(d::Int, h::Int; frame::Int)
    ...
    fpath = joinpath(OUTDIR, @sprintf("zoom-Amazon-frame_%03d.png", frame))
    save(fpath, fig; dpi=350)
end


function plotAmazon(CH4, CO2, CO)
  @show maximum(CH4)
  fig = Figure(resolution = (1050, 550), backgroundcolor = :transparent)
  ...
  cb.halign    = :0.1                # right edge
  cb.valign    = :0.15                  # top edge
